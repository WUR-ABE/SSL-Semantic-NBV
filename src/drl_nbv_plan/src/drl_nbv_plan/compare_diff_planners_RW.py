...
class Evaluator_compare_planners:
    ...
    def config_env_model(self):
        ...
        self.agent_ssl_semantic_nbv  = AgentGlobal(self.environment.view_range['num_col']*self.environment.view_range['num_row'], planner='ssl_semantic_nbv')
        self.agent_ssl_semantic_nbv.config_evaluate_only()
        self.agent_ssl_semantic_nbv.load_checkpoint('/home/jianchao/ros_workspace/paper4_semantic_nbv/src/drl_nbv_plan/materials/train/Q4/work4/PRE_%s/ssl_semantic_nbv_model_epi_2000' % self.config['recon_target'])

        self.agent_ssl_nbv = AgentGlobalWork1(self.environment.view_range['num_col']*self.environment.view_range['num_row'])
        self.agent_ssl_nbv.config_evaluate_only()
        self.agent_ssl_nbv.load_checkpoint('/home/jianchao/ros_workspace/paper4_semantic_nbv/src/drl_nbv_plan/materials/train/Q4/work2/NO_PRE_PLANT/ssl_nbv_best_model')
    ...
    def valid_once(self):
        predefined_views = np.array([6, 13, 26, 33, 46, 53, 66, 73, 86, 93, 106, 113, 126, 133, 146])
