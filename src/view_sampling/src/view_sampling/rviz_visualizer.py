...
from geometry_msgs.msg import Vector3, Point, Pose, PoseArray, Quaternion
...
class RvizVisualizer:
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher(
            "visual_current_view", MarkerArray, queue_size=50)
    ...
    def np2markerarray(self, xyzrpyw:np.array, color:list):
