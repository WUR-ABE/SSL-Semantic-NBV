...
ArmControl::ArmControl(std::string planning_group, std::string usecase) : move_group_(planning_group)
{
}
...
bool ArmControl::MoveToGoal(geometry_msgs::Pose goal_pose)
{
  ...
  if (success)
  {
    ...
    success = (move_group_.execute(my_plan) == moveit::planning_interface::MoveItErrorCode::SUCCESS);
 ...
 * Output: Status of pose update */
bool ArmControl::MoveToGoalSrv(flexcraft_msgs::ArmGoal::Request& req, flexcraft_msgs::ArmGoal::Response& res)
{
...
void ArmControl::AddCollisionObjects(std::vector<geometry_msgs::Vector3> dims, geometry_msgs::PoseArray obstacle_poses)
{
