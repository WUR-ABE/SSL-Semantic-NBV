...
inline geometry_msgs::Quaternion quaternion(float x, float y, float z, float w)
{
...
inline geometry_msgs::Pose pose(geometry_msgs::Point point, geometry_msgs::Quaternion quaternion)
{
...
inline Eigen::Matrix4d mat_from_transform(Eigen::Vector3d translation, Eigen::Quaterniond rotation)
{
...
inline float euclidean_distance(geometry_msgs::Pose pose_a, geometry_msgs::Pose pose_b)
{
  return norm(pose_a.position.x - pose_b.position.x, pose_a.position.y - pose_b.position.y,
